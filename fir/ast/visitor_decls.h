...
#include <cdk/ast/visitor_decls.h>
  ...
  virtual void do_bracket_node(fir::bracket_node *const node, int lvl) = 0;
  ...
  virtual void do_left_value_node(fir::left_value_node *const node, int lvl) = 0;
  ...
  void do_bracket_node(fir::bracket_node *const node, int lvl);
  ...
  void do_left_value_node(fir::left_value_node *const node, int lvl);
